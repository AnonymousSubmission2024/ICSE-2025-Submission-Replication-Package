...
Input: value = 999499
Expected output: 999.50k
Current output: 9994.99M
 */

/*
Changes a number into a human readable number and returns it as a string.
 */
string HumanReadableNum(int64 value) {
  ...
  if (value < 1000) {
    ...
    ++unit;
    Appendf(&s, "%.2f%c", value / 100.0, *unit);
  }
  return s;
}
...
The following method has a failing test
Input: value = 6000.0
Expected output: 1.6 h
Current output: 4.1 h
 */
